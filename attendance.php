...
$handle1 = curl_init();
$api_url = API_URL.'api/Employees/EmployeeNamesWithID';
...
if(isset($_POST['submit']))
{
    ...
    //   $exe4=mysqli_query($conn,$sql4);
      ...
      $sqlm = "SELECT * from attendance where date='".$date."' and admin_id='".$form_id."'";
      $exem = mysqli_query($conn, $sqlm);
      if($exem->num_rows > 0){
        echo "<script type=text/javascript>";
        echo "alert('Attendance Already Marked for the Date for this Training !');";
        echo "document.location.href='my_trainings.php'";
        echo"</script>";
        exit;
      }
     foreach($attendees as $att){
      $att_data = explode('|', $att);
       $sql3="INSERT INTO `attendance`( `date`, `duration`, `user_id`, `emp_id`, `emp_name`, `emp_dept`, `admin_id`) VALUES ('$date',$duration,'$att_data[0]','$att_data[2]','$att_data[1]','$att_data[3]','$form_id')";
      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Mark Attendance</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Enter Details to Mark Attendance</strong></div>
                  <div class="block-body">
                    <form class="form-horizontal" method="post">
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Name of the Training</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="name_of_training" value="<?php echo $edit_fetch_data['name'] ?>" readonly >
                        </div>
                      </div>
                      <div class="line"></div>
                    ...
                    <div class="line"></div>
                        <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Duration (In Hrs)</label>
                        <div class="col-sm-9">
                          <input type="number" class="form-control" name="duration" value="0" pattern="[0-9]+([\.,][0-9]+)?" step="0.01"
            title="This should be a number with up to 2 decimal places.">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input id="date" class="form-control date input-group-lg reg_name" type="text" name="date"  autocomplete="off" required value="" />
                        </div>
                      </div>
                      ...
                      <div class="line"></div> -->
                      <div id="collapseOne" class="form-group row">
                      <label class="col-sm-3 form-control-label">Attendees   <span  id="att-count"></span> </label>
                        <div class="col-sm-9">
                        <select class="js-example-basic-multiple form-control" id="e1" name="attendees[]" multiple="multiple">
                          <?php
                            foreach($users as $user){
                             if($edit_fetch_data['fac_id']!=$user->EmployeeId){
                              if (in_array($user->EmployeeId, $selected_ids)){
                                echo "<option value='". $user->EmployeeId ."|". $user->Name ."|". $user->EmployeeCode ."|". $user->Designation ."' selected >" .$user->Name ."</option>" ;
                              }
                              else
                              {
                              echo "<option value='". $user->EmployeeId ."|". $user->Name ."|". $user->EmployeeCode ."|". $user->Designation ."'>" .$user->Name ."</option>" ;
                              }
                             }
                            }
                          ?>
