...
$fid=$_GET['fid'];
$sql="select  * from feedback where id='$form_id'";
...
if(isset($_POST['submit']))
{
    ...
    $date=$_POST['date'];     
    $sql1="update feedback set f_duration='$duration',f_date='$date' where id=$form_id";
    ...
    if($exe){
      ...
      echo "document.location.href='trainees_edit.php?feedback_id=".$fid."'";
      echo"</script>";
   }
}
?>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Trainee Feedback Response</strong></div>
                  <div class="block-body">
                    <form class="form-horizontal" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <a class="btn btn-secondary" href="trainees_edit.php?feedback_id=<?php echo $fid; ?>">
                          Cancel</a>
