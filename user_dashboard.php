...
$sql = "SELECT * from feedback f INNER JOIN add_details a ON f.admin_id = a.id where f.user_id='".$user_data->EmployeeId."' and f.faculty_knw IS NULL and status=1 and fac_id !='".$user_data->EmployeeId."'";
$exe = mysqli_query($conn, $sql);
$form_count=mysqli_num_rows($exe);
$sql1 = "SELECT * from feedback f INNER JOIN add_details a ON f.admin_id = a.id where f.user_id='".$user_data->EmployeeId."' and f.faculty_knw IS NOT NULL and status=1 and fac_id !='".$user_data->EmployeeId."'";
$exe1 = mysqli_query($conn, $sql1);
$trainee_feedback_count=mysqli_num_rows($exe1);
$sql4 = "SELECT * from feedback_trainer f INNER JOIN add_details a ON f.admin_id = a.id where f.user_id='".$user_data->EmployeeId."' and f.audience_pre IS NOT NULL and status=1 and fac_id ='".$user_data->EmployeeId."'";
$exe4 = mysqli_query($conn, $sql4);
$trainer_feedback_count=mysqli_num_rows($exe4);
$sql3 = "SELECT * from feedback_effectiveness f INNER JOIN add_details a ON f.admin_id = a.id where f.user_id='".$user_data->EmployeeId."' and f.learning_tp IS NOT NULL and status=1 and fac_id !='".$user_data->EmployeeId."'";
$exe3 = mysqli_query($conn, $sql3);
$effectiveness_feedback_count=mysqli_num_rows($exe3);
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          <li class="active" ><a href="user_dashboard.php"> <i class="icon-home"></i>Home </a></li>
      ...
      <div class="page-content">
        ...
        <section class="no-padding-top">
          ...
          <div class="d-flex justify-content-between">
                ...
                <div class=" statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-windows"></i></div><strong>Trainee Forms Pending</strong>
                    </div>
                    <div class="number dashtext-1"><?php echo $form_count; ?></div>
                  </div>
                ...
                <div class="statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-contract"></i></div><strong>Trainee Responses Submitted</strong>
                    </div>
                    <div class="number dashtext-2"><?php echo $trainee_feedback_count; ?></div>
                  </div>
                  <div class="progress progress-template">
                ...
                <div class="statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>Trainer Responses Submitted</strong>
                    </div>
                    <div class="number dashtext-3"><?php echo $trainer_feedback_count; ?></div>
                  </div>
                  <div class="progress progress-template">
                    <div role="progressbar" style="width: 35%" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-template dashbg-3"></div>
                  </div>
                </div>
                ...
                <div class="statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-chart"></i></div><strong>Effectiveness Responses</strong>
                    </div>
                    <div class="number dashtext-4"><?php echo $effectiveness_feedback_count; ?></div>
                  </div>
                  <div class="progress progress-template">
