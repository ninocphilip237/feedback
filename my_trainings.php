    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <?php if($_SESSION['user_type'] == 'user'){ ?>  
          ...
          <li class="active" ><a href="my_trainings.php"> <i class="icon-user"></i>My Trainings</a></li>
        <?php } 
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  ...
                  <p style="padding-bottom: 20px;"><span style="color: #DB6574;">Note : &nbsp; </span>Please make sure all the trainers have submitted the attendance details before submitting a training for feedback</p>
                  <div class="">
...
if($exem->num_rows > 0){
    ...
    ?>
                        ...
                        <tr>
                          ...
                          <td <?php if($a['status']==0){ ?> style="width: 220px;"  <?php } ?> >
                          ...
                          <td> -->
                            <?php if($a['status']==0){ ?>
                            <a href="attendance.php?edit_id=<?php echo $a['id'] ?>"> 
                              <button class="btn btn-secondary btn-sm mt-2" data-toggle="tooltip" data-original-title="Add Attendance for the Training" ><i class="fa fa-plus"></i> &nbsp; Mark Attendance</button>
                            </a> &nbsp;
                             
                            <?php } ?>
                            <button class="btn btn-secondary btn-sm mt-2" data-toggle="tooltip" data-original-title="View Marked Attendance Date(s) and Duration"  onclick="viewAttendance('<?php echo $a['id'] ?>');" ><i class="fa fa-eye"></i></button>
                             &nbsp;
                             <?php if($a['fac_type']=='internal'){ ?>
                            <a class="btn btn-secondary btn-sm mt-2" target="_blank" data-toggle="tooltip" data-original-title="Attendance Sheet for the Training"  href="training_attendance_sheet.php?id=<?php echo $a['id'] ?>" ><i class="icon-padnote"></i></a>
                            <?php } ?>
                            &nbsp;
                            <a href="<?php if($_SESSION['user_type'] == 'admin'){ echo 'form_edit.php?edit_id='.$a['id']; } else { echo 'trainer_form_edit.php?edit_id='.$a['id']; } ?>"> 
                              <button class="btn btn-secondary btn-sm mt-2" data-toggle="tooltip" data-original-title="Edit Details" ><i class="fa fa-pencil"></i></button>
                            </a> &nbsp;
                          <!-- </td> -->
                          <!-- <td><a href="forms_user.php?user_id=<?php //echo $a['id'] ?>" target="_blank"> URL</a></td> -->
                          <!-- <td> -->
                            <?php if($a['status']==0){ ?>
                            <a href="javascript:void(0);" onclick="changeStatusForm('<?php echo $a['id'] ?>',1);"> 
                              <button class="btn btn-secondary btn-sm mt-2 mb-2" data-toggle="tooltip" data-original-title="Activate form for getting trainee Feedbacks" ><i class="fa fa-bullhorn"></i> &nbsp; Submit for Feedback</button>         
                            </a>
                            <?php } ?> 
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5>List of Date(s) Attendance Marked</h5>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <span id="att_dates"></span>
      </div>
    ...
    <script>
      ...
      function changeStatusForm(id,flag) {
        var r = confirm("Do you want to Activate Feedbacks for this Form !");
        if (r == true) {   
          document.location.href='status_form.php?id='+id+'&flag='+flag;
        } 
    ...
    function viewAttendance(id) {
     ...
     function deleteAttendance(id,date) {
      var r = confirm("Do you want to Delete this Attendance for Training !");
        if (r == true) {   
          document.location.href='delete_attendance_form.php?id='+id+'&date='+date;
        } 
     }
   </script>
  </body>
