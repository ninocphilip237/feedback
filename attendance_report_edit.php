...
$fid=$_GET['form'];
$att_id=$_GET['id'];
$sql="select  * from attendance where id='$att_id'";
...
if(isset($_POST['submit']))
{
    ...
    $date=$_POST['date'];     
    $sql1="update attendance set duration='$duration',date='$date' where id=$att_id";
    ...
    if($exe){
      ...
      echo "document.location.href='attendance_edit.php?id=".$fid."'";
      echo"</script>";
   }
}
?>
      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Edit Attendance</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Trainee Attendance</strong></div>
                  <div class="block-body">
                    <form class="form-horizontal" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <a class="btn btn-secondary" href="attendance_edit.php?id=<?php echo $fid; ?>">
                          Cancel</a>
