                        ...
                        <!-- <td><a href="print_trainer.php?feedback_id=<?php //echo $a['id'] ?>" target="_blank">View</a></td> -->                        
                          ...
                          <?php 
                             ...
                             if(strtotime($firstDate) < strtotime('-90 days')) {
                              ...
                              if($exem->num_rows > 0){
                              $sql1 = "SELECT * from feedback_effectiveness where admin_id='".$a['id']."' and learning_tp IS NOT NULL";
                              $exe1 = mysqli_query($conn, $sql1);
                              $row1 =  $exe1->fetch_assoc();
                              // print_r($row1);
                              $sql3 = "SELECT * From feedback where feedback.admin_id='".$a['id']."'";
                            ...
                            if($exe1->num_rows == $total){ ?>
                              </br> <a href="print_effectiveness_user.php?feedback_id=<?php echo $a['id'] ?>" target="_blank">View <?php echo $exe1->num_rows; ?> Response(s)</a>

                            <?php } else {  ?>
                              </br> <a href="effectiveness_submit.php?feedback_id=<?php echo $a['id'] ?>"> Submit Response (<?php echo $total - $exe1->num_rows;  ?> Pending) </a>
                            </br> <a href="print_effectiveness_user.php?feedback_id=<?php echo $a['id'] ?>" target="_blank">View Submitted <?php echo $exe1->num_rows; ?> Response(s)</a>
                            <?php } } }?>
                          ...
                          <td>
                            ...
                            View 
                            <?php
                              $sql5="select * from feedback_effectiveness where admin_id='".$a['id']."'";
                              $exe3=mysqli_query($conn,$sql5);
                              echo  $exe3->num_rows;
                              $sql6 = "SELECT * From feedback where feedback.admin_id='".$a['id']."'";
                              $exe6=mysqli_query($conn,$sql6);
                              $p_count = $exe6->num_rows - $total;
                            ?>
                             Response(s) (<?php echo $p_count; ?> Pending)</a>
                             <a href="effectiveness_edit.php?feedback_id=<?php echo $row1['admin_id'] ?>" target="_blank">
                             Edit</a>
                            <?php
                              }
                              else{
