...
$fid=$_GET['fid'];
$sql="select  * from feedback_trainer where id='$form_id'";
...
if(isset($_POST['submit']))
{
    ...
    $date=$_POST['date'];     
    $sql1="update feedback_trainer set f_duration='$duration',f_date='$date' where id=$form_id";
    ...
    if($exe){
      ...
      echo "document.location.href='trainers_edit.php?feedback_id=".$fid."'";
      echo"</script>";
   }
}
?>
  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="page-content">
        ...
        <div class="container-fluid">
          <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="trainers.php">Back to Forms</a></li>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Trainer Feedback Response</strong></div>
                  <div class="block-body">
                    <form class="form-horizontal" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <a class="btn btn-secondary" href="trainers_edit.php?feedback_id=<?php echo $fid; ?>">
                          Cancel</a>
