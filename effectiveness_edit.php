      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Effectives Feedback Response(s)</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
  ...
  while($looping_list=mysqli_fetch_array($exe)) {
    ...
    ?>
                        ...
                        <tr>
                          ...
                          <td>
                              <a href="effectiveness_response_edit.php?edit_id=<?php echo $looping_list['id']; ?>&fid=<?php echo $back_id; ?>">
