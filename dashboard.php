...
$sql1 = "select * from feedback where faculty_knw IS NOT NULL";
$exe1 = mysqli_query($conn, $sql1);
$trainee_feedback_count=mysqli_num_rows($exe1);
$sql2 = "select * from feedback_trainer where audience_pre IS NOT NULL";
$exe2 = mysqli_query($conn, $sql2);
$trainer_feedback_count=mysqli_num_rows($exe2);
$sql3 = "SELECT * from feedback_effectiveness f INNER JOIN add_details a ON f.admin_id = a.id where f.learning_tp IS NOT NULL and status=1 and date <= NOW() - INTERVAL 90 DAY";
      ...
      <div class="page-content">
        ...
        <div class=" statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-windows"></i></div><strong>Forms</strong>
                    </div>
                ...
                <div class="statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-contract"></i></div><strong>Trainee Responses</strong>
                    </div>
                ...
                <div class="statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>Trainer Responses</strong>
                    </div>
                ...
                <div class="statistic-block block col-sm-3">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-chart"></i></div><strong>Effectiveness</strong>
                    </div>
