    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active" ><a href="trainers_user.php"> <i class="icon-grid"></i>Trainer Feedback</a></li>
      ...
      <div class="page-content">
        ...
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Trainer Feedback </li>
          </ul>
        </div>
...
while ($t_data = mysqli_fetch_array($exe)) {
  ...
  // $sql1 = "SELECT * from feedback_trainer where user_id='".$t_data['fac_id']."' and audience_pre IS NOT NULL";
  ...
  //  while ($row1 = mysqli_fetch_array($exe1)) {
    ...
    if($exem->num_rows > 0){
         ...
         ?>
                        ...
                        <td> 
                            <?php 
                              $sql1 = "SELECT * from feedback_trainer where admin_id='".$t_data['id']."'  and user_id='".$user_data->EmployeeId."'";
                              $exe1 = mysqli_query($conn, $sql1);
                              $row1 =  $exe1->fetch_assoc();
                              // print_r($row1);
                            if($exe1->num_rows == 0){ ?>
                               <a href="trainer_user.php?feedback_id=<?php echo $t_data['id'] ?>"> Submit Response </a>
                            <?php } else {  ?>
                               <a href="print_trainer_user.php?feedback_id=<?php echo $row1['id'] ?>" target="_blank">View Response</a>
                            <?php } ?>
                          
                       </td>
                  <!-- <td><a href="delete.php?dlt_id=<?php //echo $a['id'] ?>"> Delete</a></td> -->
